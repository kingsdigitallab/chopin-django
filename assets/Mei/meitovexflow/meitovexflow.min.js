...
{clef:c,keysig:d,timesig:f};this.keySpec={key:"C",meiElement:a};this.timeSpec={};this.spacing=this.labels=null;this.clef={};this.startClefCopy=null;this.updateDef(a,b,!0)};oa.prototype={clefTypeMap:{G:"treble",G1:"french",G2:"treble",F3:"baritone-f",F4:"bass",F5:"subbass",C1:"soprano",C2:"mezzo-soprano",C3:"alto",C4:"tenor",C5:"baritone-c",perc:"percussion"},getCurrentScoreDef:function(){return this.currentScoreDef},updateDef:function(a,b,c){var d,f;this.currentScoreDef=b;var e=function(a,b,c){if(a&&
a.hasAttribute(c))return a;if(b&&b.hasAttribute(c))return b};d=e(a,b,"clef.shape");f=e(a,b,"key.pname");b=e(a,b,"meter.count");c||this.updateRenderWith(d,f,b);d&&this.updateClef(d);f&&this.updateKeySpec(f);b&&this.updateTimeSpec(b);a&&(this.updateLabels(a),this.updateSpacing(a))},updateIfNew:function(a){a!==this.currentScoreDef&&this.updateDef(null,a)},updateRenderWith:function(a,b,c){var d,f;d={clef:!1,keysig:!1,timesig:!1};f=function(a,b,c){return a.getAttribute(c)===b.getAttribute(c)};var e=function(a,
b,c,d,e){return a.getAttribute(c+e)===b.getAttribute(d+e)},g=this.clef.meiElement,h=this.keySpec.meiElement,k=this.timeSpec.meiElement;if(a){var l="clef"===g.localName?"":"clef.",p="clef"===a.localName?"":"clef.";e(g,a,l,p,"shape")&&e(g,a,l,p,"line")||(d.clef=!0)}!b||f(h,b,"key.pname")&&f(h,b,"key.accid")&&f(h,b,"key.mode")||(d.keysig=!0);!c||f(k,c,"meter.count")&&f(k,c,"meter.unit")&&f(k,c,"meter.sym")||(d.timesig=!0);this.renderWith=d},updateLabels:function(a){var b;b=a.getAttribute("label");"string"===
typeof b&&(this.label=b);a=a.getAttribute("label.abbr");"string"===typeof a&&(this.labelAbbr=a)},updateSpacing:function(a){a=a.getAttribute("spacing");null===a||isNaN(a)||(this.spacing=+a);return this.spacing},updateClef:function(a){var b,c,d;c="clef"===a.localName?"":"clef.";b=a.getAttribute(c+"shape");b||(w.warn("@clef.shape expected","No clef shape attribute found in "+r.serializeElement(a)+'. Setting default clef.shape "G".'),b="G");d=b+(a.getAttribute(c+"line")||"");b=a.getAttribute(c+"dis");
c=a.getAttribute(c+"dis.place");(d=this.clefTypeMap[d])?this.clef="8"===b&&"below"===c?{type:d,shift:-1,meiElement:a}:{type:d,meiElement:a}:(this.clef={type:"treble",meiElement:null},w.warn("Not supported","Clef definition in "+r.serializeElement(a)+" is not supported. Setting default treble clef."))},updateTimeSpec:function(a){this.timeSpec={count:+a.getAttribute("meter.count"),unit:+a.getAttribute("meter.unit"),sym:a.getAttribute("meter.sym"),meiElement:a}},updateKeySpec:function(a){this.keySpec=
{key:this.convertKeySpec(a),meiElement:a}},convertKeySpec:function(a){var b,c;b=a.getAttribute("key.pname").toUpperCase();c=a.getAttribute("key.accid");if(null!==c)switch(c){case "s":b+="#";break;case "f":b+="b";break;default:w.warn("Not supported",'expected to find value "s" or "f" instead of "'+c+'" in @key.accid of '+r.serializeElement(a)+". Ignoring processing of this attribute.")}a=a.getAttribute("key.mode");null!==a&&(b+="major"===a?"":"m");return b},clefChangeInMeasure:function(a){this.startClefCopy||
(this.startClefCopy={type:this.clef.type,size:this.clef.size,shift:this.clef.shift});this.updateClef(a);return this.clef},checkInitialClef:function(){this.startClefCopy&&(this.changedClef=this.clef,this.clef=this.startClefCopy)},finalizeClefInfo:function(){this.changedClef&&(this.clef=this.changedClef,this.changedClef=null);this.startClefCopy=null},forceSectionStartInfo:function(){this.renderWith={clef:!0,keysig:!0,timesig:!0}},forceStaveStartInfo:function(){this.renderWith.clef=!0;this.renderWith.keysig=
!0},showClefCheck:function(){if(this.renderWith.clef&&this.clef.meiElement&&"false"!==this.clef.meiElement.getAttribute("clef.visible"))return this.renderWith.clef=!1,!0},showKeysigCheck:function(){if(this.renderWith.keysig&&this.keySpec.meiElement&&"false"!==this.keySpec.meiElement.getAttribute("key.sig.show"))return this.renderWith.keysig=!1,!0},showTimesigCheck:function(){if(this.renderWith.timesig&&(this.renderWith.timesig=!1,this.timeSpec.meiElement&&"invis"!==this.timeSpec.meiElement.getAttribute("meter.rend")))return!0},
