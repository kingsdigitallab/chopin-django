 ...
 * Sanbox form EH for multiple transform
 *
 */
TransformFeature = OpenLayers.Class(OpenLayers.Control.TransformFeature, {
     ...
     *            var features = this.feature.layer.selectedFeatures;
                //alert(this.feature.layer.selectedFeatures[0].geometry);
                var feature;
                for (var f=0;f++;features.length) {
     * Parameters:
    ...
    transformFeature: function(mods) {
        if (!this._setfeature) {
            ...
            if (this.events.triggerEvent("beforetransform", mods) !== false) {
                    ...
                    var feature =this.feature; //this.feature
                    ...
                    //this.applyTransformFeature(this.feature, mods);

            }
            //todo disabled until box instantiation fixed
            /*if (this.events.triggerEvent("beforetransform", mods) !== false) {
                    for (var f=0;f<this.feature.layer.selectedFeatures.length;f++) {
                    var feature =this.feature.layer.selectedFeatures[f]; //this.feature
                    var geom = feature.geometry;
    ...
    applyTransformFeature: function(feature, mods) {
