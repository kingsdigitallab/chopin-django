...
urlpatterns = patterns('',
                       ...
                       url(r'^browse/sourceinformation/(?P<id>\d+)/$', sourceinformation,name='ocve_sourceinformation'),
                       url(r'^browse/workinformation/(?P<id>\d+)/$', workinformation,name='ocve_workinformation'),
