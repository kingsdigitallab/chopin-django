...
# Helper methods to serialize the distributed source db structures,
# primarily to make fixtures for testing
...
def serializeSource(sources):
    ...
    works = Work.objects.filter(
        workcomponent__sourcecomponent_workcomponent__sourcecomponent__source__in=sources).distinct()
